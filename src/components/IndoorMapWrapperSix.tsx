...
import { navigateToObjectSix } from "@/utils/navigationHelperSix";
import { toast } from "react-toastify";

function IndoorMapWrapperSix() {
  ...
  function handleNavigationClick() {
    setModalOpen(false);
    navigateToObjectSix(object.name, navigation, setNavigation);
  }
  return (
...
export default IndoorMapWrapperSix;
