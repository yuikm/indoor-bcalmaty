...
import { navigateToObjectFifth } from "@/utils/navigationHelperFifth";
import { toast } from "react-toastify";

function IndoorMapWrapperFifth() {
  ...
  function handleNavigationClick() {
    setModalOpen(false);
    navigateToObjectFifth(object.name, navigation, setNavigation);
  }
  return (
...
export default IndoorMapWrapperFifth;
