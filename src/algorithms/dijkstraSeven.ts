import { graphDataSeven, VertexDataSeven } from "@/store/graphDataSeven";
...
graphDataSeven.vertices.forEach((vertex) => {
...
graphDataSeven.edges.forEach((edge) => {
  ...
  const toVertex = graphDataSeven.vertices.find((vertex) => vertex.id === to);
...
function calculateDistance(vertex1: VertexDataSeven, vertex2: VertexDataSeven) {
