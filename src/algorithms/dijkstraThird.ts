import { graphDataThird, VertexDataThird } from "@/store/graphDataThird";
...
graphDataThird.vertices.forEach((vertex) => {
...
graphDataThird.edges.forEach((edge) => {
  ...
  const toVertex = graphDataThird.vertices.find((vertex) => vertex.id === to);
...
function calculateDistance(vertex1: VertexDataThird, vertex2: VertexDataThird) {
