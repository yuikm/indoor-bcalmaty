import { graphDataFifth, VertexDataFifth } from "@/store/graphDataFifth";
...
graphDataFifth.vertices.forEach((vertex) => {
...
graphDataFifth.edges.forEach((edge) => {
  ...
  const toVertex = graphDataFifth.vertices.find((vertex) => vertex.id === to);
...
function calculateDistance(vertex1: VertexDataFifth, vertex2: VertexDataFifth) {
