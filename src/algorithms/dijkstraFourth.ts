import { graphDataFourth, VertexDataFourth } from "@/store/graphDataFourth";
...
graphDataFourth.vertices.forEach((vertex) => {
...
graphDataFourth.edges.forEach((edge) => {
  ...
  const toVertex = graphDataFourth.vertices.find((vertex) => vertex.id === to);
...
function calculateDistance(
  vertex1: VertexDataFourth,
  vertex2: VertexDataFourth
) {
